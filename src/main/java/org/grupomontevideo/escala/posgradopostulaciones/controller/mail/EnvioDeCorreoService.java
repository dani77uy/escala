package org.grupomontevideo.escala.posgradopostulaciones.controller.mail;
...
public class EnvioDeCorreoService extends AbstractController {
   ...
   private void sendConfirmationEmail(final Postulacion postulacion, String correoDeCoordinadorOrigen) {
      ...
      MimeMessagePreparator preparator = mimeMessage -> {
         ...
         String text = VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, "mail.vm", CharEncoding.UTF_8, model);
   ...
   private String getBody(Postulacion postulacion) {
      Map model = new HashMap();
      model.put("postulacion", postulacion);
      return VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, "mail.vm", CharEncoding.UTF_8, model);
   }
